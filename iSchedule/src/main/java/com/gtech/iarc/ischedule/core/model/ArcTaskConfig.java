 ...
 * @revision $Id$
 */
public class ArcTaskConfig implements IArcTaskConfig {
    /* serialVersionUID */
    static final long serialVersionUID = 4176625277910214210L;
    ...
    private IArcTaskDetail ArcTaskDetail;   
...
//    }
    ...
    */
    public IArcTaskDetail getArcTaskDetail() {
	 ...
	 */
    public void setArcTaskDetail(IArcTaskDetail taskDetail) {
	...
	/**
	 * @hibernate.id column="TASK_ID" unsaved-value="null" generator-class="native"
	 * @hibernate.generator-param name="sequence" value="SEQ_COMM_TASK"
	 */
    ...
    /**
     * @return Returns the jobSchedule.
     * @hibernate.property column="TASK_SCHEDULE"
     */
     ...
     * @hibernate.property column="TASK_DETAIL_ID"
     */
    ...
    /* (non-Javadoc)
	 * @see com.gtech.iarc.ishedule.model.IArcTaskConfig#setTaskConfigId(java.lang.Long)
	 */
    ...
    /* (non-Javadoc)
	 * @see com.gtech.iarc.ishedule.model.IArcTaskConfig#setTaskDetailId(java.lang.Long)
	 */
