...
import com.gtech.iarc.ischedule.ScheduledService;
...
public class SpringBeanServiceDelegator implements ApplicationContextAware {
	...
	public static AbstractTask getTaskInstance(String jobName, String jobId,
            String className) {
        ...
        try {
            ...
            return (AbstractTask) jobConstructor.newInstance(objArray);
