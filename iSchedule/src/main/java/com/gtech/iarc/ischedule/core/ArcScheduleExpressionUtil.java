...
import com.gtech.iarc.ischedule.core.model.ArcScheduleInfoObject;
import com.gtech.iarc.ischedule.core.model.IArcTaskScheduleInfo;


/**
 * The main utility class for scheduler module.
 * <li>Instanciate any concreted Y3 Abstract class.
 * <li>Load Quartz configuration.
 ...
 * @revision $Id$
 */
public class ArcScheduleExpressionUtil {

    private static Log log = LogFactory.getLog(ArcScheduleExpressionUtil.class);
    ...
    public static InputStream getQuartzConfig() {
        ClassLoader classLoader = ArcScheduleExpressionUtil.class
                .getClassLoader();
    ...
    public static String convertToCronExpression(
            ArcScheduleInfoObject scheduleObj) {
    ...
    public static String convertToCronExpression(
    		IArcTaskScheduleInfo scheduleObj) {
        // Re-initialise the Cron table
        cronTable.clear();
...
//    }
    ...
    private static Hashtable convertAHMSToCronExp(String milliSeconds) {
        int totalSec = Integer.parseInt(milliSeconds) / 1000;
        cronTable.put(SECONDS, String.valueOf(totalSec));
        return cronTable;
    }

    private static Hashtable convertMinsToCronExp(String minutes) {
        int sec = 0;
