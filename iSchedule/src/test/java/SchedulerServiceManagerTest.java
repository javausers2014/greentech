...
//    private DefaultListableBeanFactory beanFactory;
    ...
    private IY3TaskDetail populate1stUnitTestTaskDetail() {
        ...
        viewTaskDetail.setTaskDetailShortName("UNITTESTONLY");
        viewTaskDetail.setTaskDetailFullName("1st Schedule Task for Unit Test");
    ...
    private IY3TaskDetail populate2ndUnitTestTaskDetail() {
        Y3TaskDetail viewTaskDetail = new Y3TaskDetail();
        viewTaskDetail.setTaskDetailShortName("UNITTESTONLY");
        viewTaskDetail.setTaskDetailFullName("2nd Schedule Task for Unit Test");
