...
public class SchedulerControl {
     ...
     * @throws ParseException 
     */
    public void activateJob(AbstractTask task) throws SchedulerException, ParseException {
     ...
     * @param job
     */
    public void deleteJob(AbstractTask y3Job) throws SchedulerException {
     ...
     * @param job
     */
    public void rescheduleJob(AbstractTask job) throws SchedulerException, ParseException {
        if (null == job) return;
