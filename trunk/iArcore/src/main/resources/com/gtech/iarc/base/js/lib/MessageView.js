Ext.ns("gtech.iarc");
/**
 * Generic view containing message panel to be extended by all gTech View
 * 
 */
gtech.iarc.MessageView = Ext.extend(Webtop.View, {
	/**
	...
	showMessage: function(text) {
		this.setMessage('emo-view-msg-no-icon', text);
	},
	...
	showLoadingMessage: function(text) {
		this.setMessage('emo-view-msg-loading-icon', text);
	},
	...
	buildMessagePanel: function(config) {
		...
		return {
			...
			region: 'north',						
			height: 35,
			bodyStyle: 'border-bottom: 1px solid #D0D0D0',
			style: 'padding-bottom: 10px; background: #fff',			
			html: "<div class='emo-view-msg emo-view-msg-no-icon' id='" + this._ID.MSG + "'>" +
						"<div class='emo-view-msg-body'>" + msg + "</div>" +						
				  "</div>"
	...
	buildErrorPanel: function() {
		return {
			...
			html: "<div class='emo-view-msg emo-view-msg-no-icon' id='" + this._ID.MSG + "'>" +						
						...
						"<div class='emo-view-exception-msg-body'>&nbsp;</div>" +						
				  "</div>"
