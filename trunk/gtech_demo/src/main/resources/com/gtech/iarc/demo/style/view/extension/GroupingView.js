/**
 * @class Ext.ux.grid.GroupingView
...
Ext.ux.grid.GroupingView = Ext.extend(Ext.grid.GridView, {
...
var grid = new Ext.grid.GridPanel({
    ...
    initTemplates : function(){
        Ext.ux.grid.GroupingView.superclass.initTemplates.call(this);
        this.state = {};
        ...
        if(!this.startGroup){
            this.startGroup = new Ext.XTemplate(
                '<div id="{groupId}" class="x-grid-group iarc-grid-group-{[values.rs.length > 1 ? "multi" : "single"]} {cls}">',
                    // '<div id="{groupId}-hd" class="x-grid-group-hd" style="{style}"><div class="x-grid-group-title">', this.groupTextTpl ,'</div></div>',                    
                    '<div id="{groupId}-calendar" class="iarc-grid-calendar">',                    	
                    	'<div class="iarc-grid-calendar-text">',                    	
                    		'<span class="iarc-grid-calendar-text-year">{[values.rs[0].data.start.format("Y")]}</span>', '<br/>',
                    		'<span class="iarc-grid-calendar-text-month">{[values.rs[0].data.start.format("M")]}</span>',                    		
                    	'</div>',
                    '</div>',
    ...
    onAdd : function(ds, records, index) {
        if (this.canGroup() && !this.ignoreAdd) {
            ...
            Ext.ux.grid.GroupingView.superclass.onAdd.apply(this, arguments);
        }
    },

    // private
    onRemove : function(ds, record, index, isUpdate){
        Ext.ux.grid.GroupingView.superclass.onRemove.apply(this, arguments);
    ...
    refreshRow : function(record){
        if(this.ds.getCount()==1){
            ...
            Ext.ux.grid.GroupingView.superclass.refreshRow.apply(this, arguments);
    ...
    // private
    renderUI : function(){
        var markup = Ext.ux.grid.GroupingView.superclass.renderUI.call(this);
    ...
    processEvent: function(name, e){
        Ext.ux.grid.GroupingView.superclass.processEvent.call(this, name, e);
    ...
    afterRender : function(){
        ...
        Ext.ux.grid.GroupingView.superclass.afterRender.call(this);
    ...
    afterRenderUI: function () {
        Ext.ux.grid.GroupingView.superclass.afterRenderUI.call(this);
    ...
    renderRows : function(){
        ...
        return Ext.ux.grid.GroupingView.superclass.renderRows.apply(
                    this, arguments);
    },
    ...
    doRender : function(cs, rs, ds, startRow, colCount, stripe){
        ...
        if(!this.canGroup() || this.isUpdating){
            return Ext.ux.grid.GroupingView.superclass.doRender.apply(this, arguments);
        }
        ...
        for(i = 0, len = groups.length; i < len; i++){
            ...
            buf[buf.length] = Ext.ux.grid.GroupingView.superclass.doRender.call(
    ...
    getRows : function(){
        if(!this.canGroup()){
            return Ext.ux.grid.GroupingView.superclass.getRows.call(this);
        }
        var r = [],
            gs = this.getGroups(),
            g,
    ...
    onColumnWidthUpdated : function(col, w, tw){
        Ext.ux.grid.GroupingView.superclass.onColumnWidthUpdated.call(this, col, w, tw);
        this.updateGroupWidths();
    },

    // private
    onAllColumnWidthsUpdated : function(ws, tw){
        Ext.ux.grid.GroupingView.superclass.onAllColumnWidthsUpdated.call(this, ws, tw);
        this.updateGroupWidths();
    },

    // private
    onColumnHiddenUpdated : function(col, hidden, tw){
        Ext.ux.grid.GroupingView.superclass.onColumnHiddenUpdated.call(this, col, hidden, tw);
        this.updateGroupWidths();
    },
...
// private
Ext.ux.grid.GroupingView.GROUP_ID = 9000;